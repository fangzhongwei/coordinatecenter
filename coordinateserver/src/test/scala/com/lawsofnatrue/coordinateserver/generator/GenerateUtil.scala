package com.lawsofnatrue.coordinateserver.generator
...
//      Array("slick.jdbc.MySQLProfile", "com.mysql.jdbc.Driver", "jdbc:mysql://localhost/edcenter", "edcenter", "com.lawsofnature.edcenter.repo", "root", "123456")
      Array("slick.jdbc.MySQLProfile", "com.mysql.jdbc.Driver", "jdbc:mysql://localhost/ddz", "ddz", "com.lawsofnature.ddz.repo", "root", "123456")
